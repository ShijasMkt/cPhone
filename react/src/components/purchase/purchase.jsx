            ...
            <div className="row">
              <div className="col-5">
                <div className='d-block'>
                  <div className='img-box'>
                    <img src={`http://127.0.0.1:8000${data.img}`} alt="phone"  className='phone-img'/>
                  </div>
                </div>
              </div>
              ...
              <div className="col-3">
                <div className='purchase-view'>
                  ...
                  Free Delivery : <span><b>{deliveryDate}</b></span>
                  </div>
                  <div className='purchase-view-body'>
                      <div className='bank-offers'>
                      <ul>
                      <li>Bank OfferExtra ₹250 off on HDFC Bank Pixel Credit Card Transactions. Min Txn Value: ₹5,000</li>
                      <li>Bank OfferExtra ₹500 off on HDFC Bank Pixel Credit Card EMI Transactions. Min Txn Value: ₹5,000</li>
                      <li>Bank Offer5% Unlimited Cashback on Flipkart Axis Bank Credit Card</li>
                      <li>Special PriceGet extra ₹5901 off (price inclusive of cashback/coupon)</li>
                      </ul>
                      </div>
                  </div>
                  <div className='button-section '>
                    <button type='button' className='btn btn-warning buyNow-button' onClick={()=>lastBuyPage(data)}>Buy Now</button>
