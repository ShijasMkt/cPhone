...
export default function Login({changePage}) {
  ...
  const checkLogin = async () => {
    ...
    if (res.status == 200) {
      ...
      Cookies.set('userKey', userKey,{expires : 1,sameSite:"None",secure:true});
      Cookies.set('userID',userID,{expires: 1,sameSite:"None",secure:true});
  ...
  return (
    <>
      ...
      <div className="link">
        ...
        <span data-value="SignUp" onClick={changePage}>
          Sign up
        </span>
      </div>
